...
begin
  ...
  set v_input_text = concat( 'token: ', testor_escape(p_token), '\n', 'suite_id: ', p_suite_id, '\n', 'case_id: ', p_case_id, '\n', 'test_code: ', testor_escape(p_code), '\n', 'condition: ', p_condition, '\n', 'message: ', testor_escape(p_message), '\n' );
  set v_input_json = concat( '{"token": "', testor_escape(p_token), '", "suite_id": ', p_suite_id, ', "case_id": ', p_case_id, ', "test_code": "', testor_escape(p_code), '", "condition": ', p_condition, ', "message": "', testor_escape(p_message), '"}' );
