...
drop procedure if exists api_testor_not_true;
delimiter $$
create procedure api_testor_not_true( in p_token varchar(36), out p_id bigint, in p_suite_id bigint, in p_case_id bigint, in p_code varchar(640), in p_condition int )
...
begin
  ...
  set v_code = 'api_testor_not_true';
  ...
  set v_input_json = concat( '{"token": "', testor_proxy_quote(p_token), '", "suite_id": ', p_suite_id, ', "case_id": ', p_case_id, ', "test_code": "', testor_proxy_quote(p_code), '", "condition": ', p_condition, '}' );
