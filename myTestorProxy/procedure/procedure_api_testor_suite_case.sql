...
begin
  ...
  set v_input_text = concat( 'token: ', testor_escape(p_token), '\n', 'suite_code: ', testor_escape(p_suite_code), '\n', 'case_code: ', testor_escape(p_case_code), '\n' );
  set v_input_json = concat( '{"token": "', testor_escape(p_token), '", "suite_code": "', testor_escape(p_suite_code), '", "case_code": "', testor_escape(p_case_code), '"}' );
