...
drop procedure if exists api_testor_same;
delimiter $$
create procedure api_testor_same( in p_token varchar(36), out p_id bigint, in p_suite_id bigint, in p_case_id bigint, in p_code varchar(640), in p_operand varchar(8192), in p_value varchar(8192) )
