...
begin
  ...
  set v_input_json = concat( '{"token": "', testor_escape(p_token), '", "suite_id": ', p_suite_id, ', "case_id": ', p_case_id, ', "test_code": "', testor_escape(p_code), '", "message": "', testor_escape(p_message), '"}' );
